...
<div align="center"><img src="assets/neon-grid.svg" width="100%" alt="Animated dark neon engineering grid"/></div>

## ⚡ STACK

<div align="center">
<img src="assets/dark-tech-stack.svg" width="100%" alt="Animated dark technology stack"/>
</div>
...
<div align="center">`Python` · `FastAPI` · `Django` · `Flask` · `React` · `JavaScript` · `HTML` · `CSS` · `Tailwind CSS` · `SQL` · `MySQL` · `REST APIs` · `Git` · `GitHub`</div>

<div align="center"><img src="assets/profile-divider.svg" width="100%" alt="Animated divider"/></div>

## 👨‍💻 ABOUT

<div align="center"><strong>Computer Science and Technology graduate from SNS College of Engineering.</strong><br/><br/>I focus on Python backends, REST APIs, relational data systems and React-based full-stack products, with a growing focus on system design.</div>
...
<br/><br/>
<img src="https://streak-stats.demolab.com?user=Raahin-SUhail&theme=github-dark-blue&hide_border=true"/>
<br/><br/>
...
<div align="center"><img src="assets/profile-divider.svg" width="100%" alt="Animated divider"/><br/><br/>### `build()` → `learn()` → `ship()` → `repeat()`</div>
